<template>
  <div class="sixth-simple-advertise-container">
    <div class="container">
...
export default {
  setup(props, context) {
    ...
    return { simpleAdvertise: props.sixthSimpleAdvertise, getImagePath };
  },
  props: ["sixthSimpleAdvertise"],
};
</script>

<style>
.sixth-simple-advertise-container {
  margin: 5px 0;
}
</style>
